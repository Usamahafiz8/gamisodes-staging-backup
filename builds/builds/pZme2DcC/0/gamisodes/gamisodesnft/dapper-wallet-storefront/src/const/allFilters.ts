export const allFilters = {
  ...
  genesis: [
    {
      ...
      options: [
        {
          selected: false,
          value: "Genesis Card #1",
          keyValue: "1",
        },
        {
          selected: false,
          value: "Genesis Card #2",
          keyValue: "2",
        },
        {
          selected: false,
          value: "Genesis Card #3",
          keyValue: "3",
        },
        {
          selected: false,
          value: "Genesis Card #4",
          keyValue: "4",
        },
      ],
    },
  ...
  missions: [
    {
      ...
      options: [
        ...
        { selected: false, value: "New York City" },
  ...
  moments: [{
    ...
    options: [
      { selected: false, value: "Blind Box", keyValue: 'blind box' },
      { selected: false, value: "Trading Card", keyValue: 'trading card' },
      { selected: false, value: "Postcard", keyValue: 'postcard' },
      { selected: false, value: "Art Print", keyValue: 'art print' },
      { selected: false, value: "Packaging", keyValue: 'packaging' },
    ],
  },
  {
    label: "Rarity",
